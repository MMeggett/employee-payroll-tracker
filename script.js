...
const getRandomEmployee = function (employeesArray) {
    ...
    console.log(randomEmployee, "Congratulations to " + employeesArray[randomEmployee].firstName + " " + employeesArray[randomEmployee].lastName + " our random drawing winner!")
}
